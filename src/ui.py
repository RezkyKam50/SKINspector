...
class SkinSpectorApp(QWidget):
    """Main application window for SkinSpector."""
    ...
    def create_logs_tab(self) -> QWidget:
        """Create the logs tab that displays stdout/stderr."""
        tab = QWidget()
        layout = QVBoxLayout()
    ...
    def append_log_text(self, text: str):
        """Append logs to the logs_output QTextEdit."""
    ...
    def on_document_processing_finished(self):
        """Clean up when document processing finishes"""
    ...
    def upload_image(self) -> None:
        """Handle image upload and trigger description."""
        file_path, _ = QFileDialog.getOpenFileName(
    ...
    def start_image_processing(self) -> None:
        """Run LLM analysis in a separate thread using QThread."""
    ...
    def on_analysis_finished(self):
        """Clean up when analysis finishes"""
    ...
    def append_text(self, text: str) -> None:
        """Append streamed text to output area (thread-safe via signal)."""
